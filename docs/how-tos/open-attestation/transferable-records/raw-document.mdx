...
Replace the value of `issuers[0].tokenRegistry` from `0x8431012Bc040942B59e3C5bf428221eab0b2f723` to the smart contract address of your token registry in the [previous steps](/docs/how-tos/open-attestation/transferable-records/token-registry/token-registry-cli)

#### 1. issuers[0].identityProof.location

Replace the value of `issuers[0].identityProof.location` from `few-green-cat.sandbox.openattestation.com` to the dns name used to bind the token registry's identity in the [previous steps](/docs/how-tos/open-attestation/transferable-records/dns)
...
- [CLI](/docs/how-tos/open-attestation/transferable-records/wrapping-document/wrapping-document-cli)
- [Code](/docs/how-tos/open-attestation/transferable-records/wrapping-document/wrapping-document-code)
