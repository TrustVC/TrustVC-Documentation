...
While there exists many [DIDs](/docs/glossary#did-decentralized-identifiers), this tutorial will focus only on `ethr` DID. At the moment, TrustVC only supports `ethr` DID.
