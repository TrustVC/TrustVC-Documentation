...
Both the signed and committed TrustVC file can then be distributed to recipients, who will be able to verify the file on https://trustvc.io simply by dragging and dropping it into the Web interface.
