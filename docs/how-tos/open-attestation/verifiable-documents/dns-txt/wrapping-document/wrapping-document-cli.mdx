...
pagination_next: how-tos/open-attestation/verifiable-documents/dns-txt/issuing-document/issuing-document-cli
pagination_prev: how-tos/open-attestation/verifiable-documents/dns-txt/raw-document
---
...
> For the current step, you can either opt to use the [CLI](/docs/how-tos/open-attestation/verifiable-documents/dns-txt/wrapping-document/wrapping-document-cli) or [Code](/docs/how-tos/open-attestation/verifiable-documents/dns-txt/wrapping-document/wrapping-document-code).
...
> Visit our github page to learn more about [TrustVC CLI wrapping](https://github.com/trustvc/trustvc-cli/#wrapping-documents)!
