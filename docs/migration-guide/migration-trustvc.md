...
- [Token Registry v5 Overview](/docs/migration-guide/igp-i) – Detailed documentation on the new methods and enhancements.
- [Token Registry v5 Migration Guide](/docs/migration-guide/migration-tr-v5) – Step-by-step guide for migrating your codebase to Token Registry v5.
